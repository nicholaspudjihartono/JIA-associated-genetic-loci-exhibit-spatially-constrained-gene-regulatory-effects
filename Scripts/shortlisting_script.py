...
#"risk_loci_dict" below is a dictionary containing 71 JIA risk loci as the keys, and its LD partners as the values (see Supplementary Table 3 in the manuscript)
